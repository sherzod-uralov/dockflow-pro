...
export const endpoints = {
  ...
  chat: {
    ...
    visibility: (id: string) => `/chat/${id}/visibility`,
    permissions: (id: string) => `/chat/${id}/permissions`,
    inviteRegenerate: (id: string) => `/chat/${id}/invite/regenerate`,
    publicSearch: "/chat/public/search",
    joinInvite: "/chat/join/invite",
    joinUsername: "/chat/join/username",
    block: (userId: string) => `/chat/block/${userId}`,
    blockList: "/chat/block/list",
    clearHistory: (id: string) => `/chat/${id}/clear-history`,
  },
  auditLog: {
    list: "audit-log",
    create: "audit-log",
