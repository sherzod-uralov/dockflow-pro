...
export const errorHandlers = {
  ...
  foydalanuvchi: createErrorHandler("Foydalanuvchi"),
  rol: createErrorHandler("Rol"),
  mahsulot: createErrorHandler("Mahsulot"),
  buyurtma: createErrorHandler("Buyurtma"),
  kategoriya: createErrorHandler("Kategoriya"),
  hisobot: createErrorHandler("Hisobot"),
  sozlamalar: createErrorHandler("Sozlamalar"),
  fayl: createErrorHandler("Fayl"),
  moliya: createErrorHandler("Moliya"),
  mijoz: createErrorHandler("Mijoz"),
  yetkazuvchi: createErrorHandler("Yetkazib beruvchi"),
};

export const {
  ruxsat: handlePermissionError,
  foydalanuvchi: handleUserError,
  rol: handleRoleError,
  mahsulot: handleProductError,
  buyurtma: handleOrderError,
  kategoriya: handleCategoryError,
  hisobot: handleReportError,
  sozlamalar: handleSettingsError,
  fayl: handleFileError,
  moliya: handleFinanceError,
  mijoz: handleCustomerError,
  yetkazuvchi: handleSupplierError,
} = errorHandlers;
