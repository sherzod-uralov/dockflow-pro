...
const PermissionView = ({ permission, onClose }: PermissionViewProps) => {
  return (
          ...
          <div className="flex items-start justify-between">
            ...
            {permission.id && (
              <Badge
                ...
                onClick={() => handleCopyToClipboard(permission.id!, "ID")}
              >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  ...
                  onClick={() => handleCopyToClipboard(permission.key, "Kalit")}
                >
          ...
          <div>
            ...
            <div className="p-4 bg-muted/30 rounded-lg border">
              <p className="text-sm leading-relaxed">
                {permission.description || "Tavsif kiritilmagan"}
              </p>
            </div>
          </div>
