...
describe('deportamentService', () => {
    ...
    describe('getAllDeportaments', () => {
        test('barcha bo\'limlarni olib keladi', async () => {
            ...
            const result = await deportamentService.getAllDeportaments(params)
    ...
    describe('createDeportament', () => {
        test('yangi bo\'lim yaratadi', async () => {
            ...
            const result = await deportamentService.createDeportament(mockPayload)
    ...
    describe('updateDeportament', () => {
        test('bo\'limni yangilaydi', async () => {
            ...
            const result = await deportamentService.updateDeportament('1', mockPayload)
    ...
    describe('getDeportamentById', () => {
        test('bo\'limni ID bo\'yicha olib keladi', async () => {
            const mockResponse = { data: { id: '1', name: 'Dept' } }
                ; (axiosInstance.get as jest.Mock).mockResolvedValue(mockResponse)

            const result = await deportamentService.getDeportamentById('1')
